        ...
        <div className='w-11/12 md:w-9/12 mx-auto py-20'>
            <div className='grid md:grid-cols-2 gap-10'>
                ...
                <div>
                    ...
                    <p className='font-secondary text-slate-600 text-lg mt-10  text-justify'>At Melody School, we believe that music has the power to inspire, heal, and transform lives. It is our mission to cultivate a love for music in each and every student, providing them with a solid foundation and empowering them to explore their artistic potential. Our dedicated team of passionate music educators brings a wealth of experience and knowledge to the classroom.</p> <br />
